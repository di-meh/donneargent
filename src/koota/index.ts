...
import { IsCoin, IsIngot, IsStack, Mesh, Money, Position, Velocity } from "./traits";
...
export const actions = createActions((world: World) =>  ({
    throwMoney: (moneyType: MoneyType) => {
        ...
        const type : Trait<{monetaryValue: number}> = 
            moneyType === MoneyType.Coin ? IsCoin :
        ...
        console.log(`Money thrown: ${moneyType}, remaining amount: ${currentMoney?.amount}, monetary value: ${entity.get(type)?.monetaryValue}`);
